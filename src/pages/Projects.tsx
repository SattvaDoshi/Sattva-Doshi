  ...
  const projects = [
    {
      ...
      description: 'A complete ride booking and event management platform built for the Brotherhood of Mumbai (BOM) riding club with admin-controlled rides, events, coupons, and real-time monitoring.',
      overview: 'A full-fledged ride booking and management system developed for BOM - Brotherhood of Mumbai riding club. The platform enables users to book rides, join events, purchase group tickets, apply coupon discounts, and track ride details. The admin dashboard provides complete control with CRUD operations for rides, events, coupons, riders, and discounts, along with real-time monitoring of bookings and user activity.',
      technologies: ['React', 'Node.js', 'MongoDB', 'Razorpay', 'Nodemailer', 'AWS', 'Socket.io'],
      keyFeatures: [
        'Ride and event booking system',
        'Admin dashboard with full CRUD for rides, events, and coupons',
        'Real-time monitoring of bookings and rider activity',
        'Group ticketing and automated discount system',
        'Secure payment integration using Razorpay',
        'Email notifications and ride confirmations via Nodemailer',
        'Mobile-responsive UI optimized for riders',
        'Search and filter for upcoming rides and events'
      ],
      challenges: 'Implementing a robust real-time monitoring system for admins to track bookings, coupon usage, and group ticket validations while maintaining system scalability.',
      results: 'Enabled BOM to digitize their ride booking workflow with a 70% reduction in manual coordination and improved rider experience through group booking and discount automation.',
      duration: '2 months',
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            {filters.map((filter) => (
              <button
                ...
                className={`px-6 py-3 rounded-lg font-medium transition-all duration-300 ${selectedFilter === filter.key
